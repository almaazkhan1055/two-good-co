...
function videoconAnimation() {
  ...
  videocon.addEventListener("mousemove", (scroller) => {
    gsap.to(buybtn, {
      left: scroller.x - 70,
      top: scroller.y - 80,
    });
...
function openbtn() {
  document.querySelector(".ri-menu-line").addEventListener("click", () => {
    document.querySelector("#ham").style.top = "0";
  });
  document.querySelector(".div-btn button").addEventListener("click", () => {
    document.querySelector("#ham").style.top = "-1000px";
  });
}
openbtn();
